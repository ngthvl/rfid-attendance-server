...
Route::middleware('api')->prefix('api/v1/admin')->group(function(){
    ...
    Route::middleware('auth:admin')->group(function(){
        Route::get('me', [\Tamani\Admin\Http\Controllers\V1\Auth\AuthController::class, 'me']);
    ...
    Route::get('download-file', \Tamani\Admin\Http\Controllers\V1\Admin\AuthDownloadController::class);
});
